...
class FSK(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "Modulacion FSK", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Modulacion FSK")
        ...
        self._n_win = RangeWidget(self._n_range, self.set_n, "#de bit por simbolo", "counter_slider", float, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._n_win)
        self._kf_range = Range(-2*math.pi, 2*math.pi, 1e-3, math.pi/2, 200)
        self._kf_win = RangeWidget(self._kf_range, self.set_kf, "coeficiente de sensibilidad kf (rad/volt)", "counter_slider", float, QtCore.Qt.Horizontal)
        ...
        self._DC_win = RangeWidget(self._DC_range, self.set_DC, "Nivel promedio de la señal modulante", "counter_slider", float, QtCore.Qt.Horizontal)
        ...
        self._kp_range = Range(-2*math.pi, 2*math.pi, 1e-3, math.pi/math.pow(2,n), 200)
        self._kp_win = RangeWidget(self._kp_range, self.set_kp, "Coeficiente de sensibilidad kp (MHz/volt)", "counter_slider", float, QtCore.Qt.Horizontal)
