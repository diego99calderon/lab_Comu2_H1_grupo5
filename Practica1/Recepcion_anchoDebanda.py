...
class Recepcion_anchoDebanda(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "labcom", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("labcom")
        ...
        self.settings = Qt.QSettings("GNU Radio", "Recepcion_anchoDebanda")
        ...
        self._GRX_range = Range(0, 31.5, 500e-3, 0, 200)
...
def main(top_block_cls=Recepcion_anchoDebanda, options=None):
