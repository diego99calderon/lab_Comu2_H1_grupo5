...
class Practica1_labComu2_sub5(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "PracticaAnchoBanda", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("PracticaAnchoBanda")
        ...
        self.settings = Qt.QSettings("GNU Radio", "Practica1_labComu2_sub5")
        ...
        # Blocks
        ##################################################
        self._fc_range = Range(50e6, 2200e6, 1e6, 100e6, 200)
        ...
        self._NO_range = Range(1e-6, 500e-3, 1e-6, 250e-3, 200)
...
def main(top_block_cls=Practica1_labComu2_sub5, options=None):
