...
class BER(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "BERComu2", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("BERComu2")
        ...
        # Variables
        ##################################################
        self.samp_rate = samp_rate = 125000000/2
        self.n = n = 1
        self.No = No = 0.562
        self.DC = DC = -1
        self.B = B = 8
        ...
        self._n_win = RangeWidget(self._n_range, self.set_n, "# de bit por simbolo", "counter_slider", int, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._n_win)
        self._No_range = Range(0, 800e-3, 100e-6, 0.562, 200)
        ...
        self._DC_win = RangeWidget(self._DC_range, self.set_DC, "Nivel Dc de la señal modulante", "counter_slider", float, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._DC_win)
        self._B_range = Range(1, 12, 1, 8, 200)
        ...
        self.low_pass_filter_0 = filter.fir_filter_fff(
            ...
            firdes.low_pass(
                ...
                window.WIN_HAMMING,
                6.76))
        self.fec_ber_bf_0 = fec.ber_bf(False, 100, -12.0)
        ...
        self.connect((self.digital_binary_slicer_fb_0, 0), (self.blocks_char_to_float_0_1, 0))
