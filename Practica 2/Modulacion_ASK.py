...
class Modulacion_ASK(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "Modulacion_ASK")
        ...
        # Blocks
        ##################################################
        self._ka_range = Range(0, 2, 0.1, 1, 200)
...
def main(top_block_cls=Modulacion_ASK, options=None):
