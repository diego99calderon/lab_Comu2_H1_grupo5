...
# Title: Sindy Chapeta, Diego Calderon
# Author: lab comu2 grupo 5
...
class Modulacion_ASK_M_ARIA(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Sindy Chapeta, Diego Calderon", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Sindy Chapeta, Diego Calderon")
        ...
        self.settings = Qt.QSettings("GNU Radio", "Modulacion_ASK_M_ARIA")
        ...
        self._n_win = RangeWidget(self._n_range, self.set_n, "num bit por muestra", "counter_slider", float, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._n_win)
        self._ka_range = Range(0, 2, 100e-3, 100e-3, 200)
        ...
        self._fc_range = Range(50e6, 2200e6, 1e6, 400e6, 200)
        ...
        self._No_range = Range(0, 10e-3, 1e-4, 1e-3, 200)
        ...
        self._Dc_range = Range(-8, 8, 10e-3, 0, 200)
        ...
        self._B_range = Range(1, 20, 1, 10, 200)
        self._B_win = RangeWidget(self._B_range, self.set_B, "# de muestras por simbolo", "counter_slider", int, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._B_win)
        self._Ac_range = Range(0, 1, 10e-3, 250e-3, 200)
        ...
        self._interpolation_range = Range(10, 100, 10, 10, 200)
        self._interpolation_win = RangeWidget(self._interpolation_range, self.set_interpolation, "'interpolation'", "counter_slider", int, QtCore.Qt.Horizontal)
        ...
        self.analog_random_source_x_0 = blocks.vector_source_b(list(map(int, numpy.random.randint(0, 2**n, int(samp_rate)))), True)
...
def main(top_block_cls=Modulacion_ASK_M_ARIA, options=None):
